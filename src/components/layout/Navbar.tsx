...
export function Navbar() {
  ...
  return (
    ...
    >
      <div className="glass-panel rounded-full px-2 py-2 flex items-center gap-1 pointer-events-auto max-w-full overflow-x-auto no-scrollbar">
        {SECTIONS.map((section) => {
          ...
          return (
            <a
              ...
              href={`#${section.id}`}
              className={cn(
                "relative px-4 py-2 rounded-full text-sm font-medium transition-colors whitespace-nowrap shrink-0",
